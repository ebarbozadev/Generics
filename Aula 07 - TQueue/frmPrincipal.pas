...
begin
  ...
  begin
    ...
    MessageDlg('A senha deve ter no máximo 5 números', TMsgDlgType.mtError, [TMsgDlgBtn.mbOK], 0);
...
begin
  ProximaSenha     := ListaQueue.Peek.ToString;
  SenhaFormatada   := FormatFloat('00000', ProximaSenha.ToInteger);
  Label3.Caption   := SenhaFormatada;
end;
